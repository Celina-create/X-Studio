...
| 4 | [`seed-user-pool-stratification`](./skills/seed-user-pool-stratification) | 把种子用户池**按 ROI 分层**，决定先发谁、最后发谁 |
| 5 | [`personalized-cold-outreach`](./skills/personalized-cold-outreach) | 给一份种子 CSV，**批量生成 1 对 1 个性化冷邮件**——开头三句必须只对该用户成立 |
| 6 | [`landing-to-issue-funnel`](./skills/landing-to-issue-funnel) | 把**冷邮件 → 落地页 → 预填好的 GitHub Issue** 串成捕获漏斗，每一次反馈都成为公开资产 |
| 7 | [`content-repurpose-engine`](./skills/content-repurpose-engine) | 一条核心洞察 → **同时输出中英 thread / 长文 / 视频钩子**，单点投入多平台分发 |
| 8 | [`growth-experiment-template`](./skills/growth-experiment-template) | 结构化的**增长实验文档模板**——假设、指标、决策规则、回顾 |
| 9 | [`reddit-account-warmup`](./skills/reddit-account-warmup) | **Reddit 账号 6 周养成 SOP**——发帖 60 秒清单、karma 涨分公式、删帖恢复 SOP |
| 10 | [`community-content-bot`](./skills/community-content-bot) | **飞书 + Discord 双语日推机器人**——GitHub Actions 跑，60 分钟落地，月成本 < $10 |
