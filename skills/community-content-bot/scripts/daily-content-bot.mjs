#!/usr/bin/env node
/**
 * Bilingual daily content push bot for developer communities.
 *
 * Source: open-source pattern, originally deployed in a production
 * developer community then paused (see case-studies/01-content-bot-postmortem.md).
 *
 * Customize before deploying:
 *  - PROJECT_NAME: your project name
 *  - PROJECT_REPO: your GitHub repo (owner/name)
 *  - DOCS_BASE_URL: your docs site
 *  - PROJECT_AVATAR: any 200x200 PNG/JPG URL
 */

const PROJECT_NAME = process.env.PROJECT_NAME || "YourProject";
const PROJECT_REPO = process.env.PROJECT_REPO || "your-org/your-repo";
const DOCS_BASE_URL = process.env.DOCS_BASE_URL || "https://docs.example.com";
const PROJECT_AVATAR =
  process.env.PROJECT_AVATAR ||
...
function buildBilingualPrompt(theme, hnStories, dateStr) {
  ...
  return `You are the tech content editor for the ${PROJECT_NAME} open-source community. You write daily content for developer groups.
        ...
        elements: [
          {
            ...
            url: `https://github.com/${PROJECT_REPO}/labels/good-first-issue`,
            type: "default",
          },
        ],
      },
        ...
        elements: [
          {
            ...
            url: `${DOCS_BASE_URL}/zh/guide/first-pr`,
            type: "default",
          },
        ],
      },
        ...
        elements: [
          {
            ...
            url: `${DOCS_BASE_URL}/zh/guide/contributor-rewards`,
            type: "default",
          },
        ],
      },
    ...
    embeds: [
      {
        ...
        author: {
          name: `${PROJECT_NAME} Daily · ${dateStr}`,
          url: `https://github.com/${PROJECT_REPO}`,
          icon_url: PROJECT_AVATAR,
        },
      },
    ],
    components: [
      {
        ...
        components: [
          ...
          },
          {
            ...
            url: `${DOCS_BASE_URL}/en/guide/first-pr`,
          },
          {
            type: 2,
            style: 5,
            label: "Rewards",
            url: `${DOCS_BASE_URL}/en/guide/contributor-rewards`,
          },
        ],
      },
    ],
